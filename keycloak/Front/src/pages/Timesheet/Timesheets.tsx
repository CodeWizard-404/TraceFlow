...
const TimesheetsSkeleton: React.FC = () => (
  <div className="timesheets-container">
    ...
    <div className="filter-bubble">
      <div
        className="custom-skeleton pulsing"
        style={{ width: "160px", height: "40px", marginBottom: "8px" }}
      />
...
const Timesheets: React.FC = React.memo(() => {
  ...
  const debouncedSetSupervisorSearch = useMemo(
    () => debounce((value: string) => setSupervisorSearch(value), 300),
    []
  );
  ...
  const sortVisitsByTime = useCallback(
    (visits: VisitWithSupervisor[]): VisitWithSupervisor[] =>
  ...
  }, [filteredTimesheets, currentYear, currentWeek, getWeekDays]);
  ...
  }, [filteredTimesheets, currentDay, sortVisitsByTime]);
  ...
  const handleValidateTimesheet = useCallback(
    ...
    [userPermissions.canValidateTimesheets, filteredTimesheets, fetchTimesheets]
  );
