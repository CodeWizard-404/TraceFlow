...
router.put('/:id/log', requirePermission('log_visits'), uploadPhotos.array('photos'), VisitController.logVisit);
router.get('/:id', requirePermission('access_visit_details'), VisitController.getVisitByID);
router.put('/:id', requirePermission('edit_visit_details'), uploadPhotos.array('photos'), VisitController.updateVisit);
