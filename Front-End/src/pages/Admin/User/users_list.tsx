    ...
    const filteredAndSortedUsers = useMemo(() => {
        ...
        if (!isSuperAdmin) {
            result = result.filter(user =>
                !user.Roles?.some(r => r.name === import.meta.env.VITE_ROLES_SUPER_ADMIN)
            );
        }
        ...
        result.sort((a, b) => {
            const aIsSuperAdmin = a.Roles?.some(r => r.name === import.meta.env.VITE_ROLES_SUPER_ADMIN) || false;
            const bIsSuperAdmin = b.Roles?.some(r => r.name === import.meta.env.VITE_ROLES_SUPER_ADMIN) || false;
                ...
                <div className="table-container">
                    ...
                    <div className="table-body">
                        {paginatedUsers.length > 0 ? (
                            ...
                            <div className="table-row">
                                <div className="table-cell">No users found</div>
                            </div>
                        )}
                    </div>
                </div>
