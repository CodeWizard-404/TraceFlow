    ...
    useEffect(() => {
        ...
        const fetchAgents = async () => {
            ...
            try {
                ...
                const validAgents = validAgentsDeduplicated.filter((agent) =>
                    tempDelegations.some((d) => d.delegationID === agent.delegationID)
                );
                ...
                <div className="dropdown-body">
                    ...
                    {showConfirm && (
                        ...
                        >
                            ...
                            <button onClick={() => showConfirm.onConfirm(true)}>Yes</button>
