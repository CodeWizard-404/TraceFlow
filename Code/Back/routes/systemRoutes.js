 ...
 *     description: Retrieves all system logs with optional filtering by level, date, or context.
 *     tags: [System]
 *     security:
 *       - cookieAuth: []
 *     parameters:
 ...
 *     description: Retrieves system logs filtered by a specific category (e.g., auth, system, api).
 *     tags: [System]
 *     security:
 *       - cookieAuth: []
 *     parameters:
 ...
 *     description: Deletes logs based on provided filters (e.g., level, date range, category). Triggers a `system:logs_deleted` notification.
 *     tags: [System]
 *     security:
 *       - cookieAuth: []
 *     requestBody:
 ...
 *     description: Archives logs based on filters (e.g., level, date range, category). Triggers a `system:logs_archived` notification.
 *     tags: [System]
 *     security:
 *       - cookieAuth: []
 *     requestBody:
 ...
 *     description: Retrieves statistics about system logs, such as counts by level, category, and time range.
 *     tags: [System]
 *     security:
 *       - cookieAuth: []
 *     parameters:
 ...
 *     description: Exports system logs in a downloadable format (e.g., CSV, JSON) based on filters.
 *     tags: [System]
 *     security:
 *       - cookieAuth: []
 *     parameters:
 ...
 *     description: Deletes all system logs. Triggers a `system:logs_cleared` notification.
 *     tags: [System]
 *     security:
 *       - cookieAuth: []
 *     responses:
 ...
 *     description: Retrieves unique values for a specified log field (e.g., category, level).
 *     tags: [System]
 *     security:
 *       - cookieAuth: []
 *     parameters:
 ...
 *     description: Retrieves the health status of the logging system.
 *     tags: [System]
 *     security:
 *       - cookieAuth: []
 *     responses:
 ...
 *     description: Retrieves performance metrics for the logging system, such as log rate and error rate.
 *     tags: [System]
 *     security:
 *       - cookieAuth: []
 *     responses:
