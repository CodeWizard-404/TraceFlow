            ...
            if (
                ...
                try {
                    ...
                    debouncedNavigate('/login', {
                        replace: true,
                        state: {
                            error: (typeof refreshError === 'object' && refreshError !== null && 'message' in refreshError && typeof (refreshError as any).message === 'string'
                                ? (refreshError as any).message.includes('Session not found')
                                : false)
